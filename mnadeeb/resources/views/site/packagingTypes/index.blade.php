        ...
        <div class="page-content">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn dark btn-outline btn-circle btn-sm" href="{{url('packagingTypes')}}">
                               اضافة
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url("packagingTypes/$item->id/edit")}}">
                                            <button class="btn btn-warning label-sm">تعديل</button>
                                        </a>
                                        <form onsubmit='return ConfirmDelete()' method="post" action="{{url("packagingTypes/$item->id")}}">
                                            {{ method_field('DELETE') }}
