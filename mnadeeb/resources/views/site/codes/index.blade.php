        ...
        <div class="page-content">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn dark btn-outline btn-circle btn-sm" href="{{url('codes/create')}}">
                               اضافة
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>{{$item->discount}}</td>
                                    <td>
                                        <a href="{{url("codes/$item->id/edit")}}">
                                            <button class="btn btn-warning label-sm">تعديل</button>
                                        </a>
                                        <form onsubmit='return ConfirmDelete()' method="post" action="{{url("codes/$item->id")}}">
                                            {{ method_field('DELETE') }}
